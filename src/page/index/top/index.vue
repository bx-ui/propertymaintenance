<template>
  <div class="top">
    <h1 class="top-title">
      <div class="top_icons">
        ...
        <div class="top_icon" v-if="menuType!=='top'">
          <i
            class="tunnyicon icon-tunny-shouqian tag-collapse"
    ...
    <div class="top-button is-right">
      <!-- <el-tooltip
        class="item icon_first"
        effect="dark"
        :content="isFullScren?'退出全屏':'全屏'"
        placement="bottom"
      >
        <span class="top-item">
          <i class="tunnyicon icon-tunny-fangda" @click="handleScreen"></i>
        </span>
      </el-tooltip>-->
      <!-- <el-badge value="3" class="item">
        <i class="tunnyicon icon-tunny-xiaoxi"></i>
      </el-badge>-->
      <span class="el-dropdown-link icon_left icon_trans">{{userInfo.userRealname}}</span>
      <!-- <el-dropdown class="item_name" placement="bottom-start">
        
        <span class="el-dropdown-link">{{userInfo.userRealname}}</span>
      ...
      <el-tooltip class="item" effect="dark" content="退出" placement="bottom" @click.native="logout">
        <img class="top-userImg" src="../../../assets/img/logout.png" />
      </el-tooltip>
    </div>
  </div>
</template>
